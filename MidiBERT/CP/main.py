...
def get_args():
    ...
    ### parameter setting ###
    parser.add_argument('--pos_type', type=str, default='relative_key_query')
...
def main():
    ...
    trainer = BERTTrainer(midi_bert, train_loader, valid_loader, args.lr, args.batch_size, args.max_seq_len,
    ...
    for epoch in range(args.epochs):
        ...
        weighted_score = [x*y for (x,y) in zip(valid_acc, midi_bert.n_tokens)]
        avg_acc = sum(weighted_score)/sum(midi_bert.n_tokens)
